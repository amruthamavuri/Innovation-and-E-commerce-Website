...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_FILES['resume']) && $_FILES['resume']['error'] == 0) {
        ...
        if (move_uploaded_file($resumeTmpName, $resumeDestination)) {
            ...
            $stmt = $conn->prepare("INSERT INTO mob_job (fullName, email, phone, platforms, programmingLanguages, frameworks, experience, projects, portfolio, experienceDetails, resume) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
            ...
            // Bind parameters
            $stmt->bind_param("sssssssssss", $fullName, $email, $phone, $platforms, $programmingLanguages, $frameworks, $experience, $projects, $portfolio, $experienceDetails, $resumeDestination);
