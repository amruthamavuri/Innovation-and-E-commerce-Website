...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_FILES['resume']) && $_FILES['resume']['error'] == 0) {
        ...
        if (move_uploaded_file($resumeTmpName, $resumeDestination)) {
            ...
            $stmt = $conn->prepare("INSERT INTO ai_job (fullName, email, phone, skills, experience, projects, portfolio, experienceDetails, resume) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
            ...
            // Bind parameters
            $stmt->bind_param("sssssssss", $fullName, $email, $phone, $skills, $experience, $projects, $portfolio, $experienceDetails, $resumeDestination);
